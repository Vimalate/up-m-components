...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: emits }) {
    ...
    watch(() => province.value, (val) => {
      var _a;
      if (val) {
        const cities = (_a = areas.value.find((item) => item.code === province.value)) == null ? void 0 : _a.children;
    ...
    watch(() => city.value, (val) => {
      var _a;
      if (val) {
        const area2 = (_a = selectCity.value.find((item) => item.code === city.value)) == null ? void 0 : _a.children;
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", null, [
        ...
        createVNode(_component_el_select, {
          ...
          default: withCtx(() => [
            (openBlock(true), createElementBlock(Fragment, null, renderList(selectArea.value, (item) => {
              return openBlock(), createBlock(_component_el_option, {
                key: item.code,
                label: item.name,
                value: item.code
