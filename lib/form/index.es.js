import { defineComponent, ref, onMounted, watch, resolveComponent, unref, openBlock, createBlock, mergeProps, withCtx, createElementBlock, Fragment, renderList, resolveDynamicComponent, renderSlot, createCommentVNode, createTextVNode, toDisplayString, createVNode, nextTick } from "vue";
  ...
  setup(__props, { expose, emit: emits }) {
          ...
          if (item.type === "editor") {
            nextTick(() => {
              if (document.getElementById("editor")) {
                ...
                editor.create();
                editor.txt.html(item.value || "<p>\u7528 JS \u8BBE\u7F6E\u7684\u5185\u5BB9</p>");
    ...
    return (_ctx, _cache) => {
      ...
      return unref(model) ? (openBlock(), createBlock(_component_el_form, mergeProps({
        ...
        ref_key: "form",
        ref: form,
        "validate-on-rule-change": __props.ruleChange,
            ...
            return openBlock(), createElementBlock(Fragment, { key: index2 }, [
              !item.children || !item.children.length ? (openBlock(), createBlock(_component_el_form_item, {
                ...
                default: withCtx(() => [
                  item.type !== "upload" && item.type !== "editor" ? (openBlock(), createBlock(resolveDynamicComponent(`el-${item.type}`), mergeProps({
                  ...
                  }, item.attrs), null, 16, ["placeholder", "modelValue", "onUpdate:modelValue"])) : item.type === "upload" ? (openBlock(), createBlock(_component_el_upload, mergeProps({ key: 1 }, item.uploadAttrs, {
                    ...
                    _: 2
                  }, 1040, ["http-request"])) : item.type === "editor" ? (openBlock(), createElementBlock("div", _hoisted_1)) : createCommentVNode("", true)
                ]),
                _: 2
              }, 1032, ["label", "rules", "prop"])) : createCommentVNode("", true),
              item.children && item.children.length ? (openBlock(), createBlock(_component_el_form_item, {
                key: 1,
                label: item.label,
                rules: item.rules,
                    ...
                    default: withCtx(() => [
                      (openBlock(true), createElementBlock(Fragment, null, renderList(item.children, (child, i) => {
                        return openBlock(), createBlock(resolveDynamicComponent(`el-${child.type}`), {
                          ...
                          default: withCtx(() => [
                            child.text ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
        ...
        _: 3
      }, 16, ["validate-on-rule-change", "label-width", "model"])) : createCommentVNode("", true);
    };
  }
});
var index = {
