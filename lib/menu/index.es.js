...
const _sfc_main$4q = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createBlock(_component_el_menu, mergeProps(_ctx.$attrs, {
          ...
          (openBlock(true), createElementBlock(Fragment, null, renderList(__props.data, (item, i) => {
            return openBlock(), createElementBlock(Fragment, { key: i }, [
              ...
              item[__props.children] && item[__props.children].length ? (openBlock(), createBlock(_component_el_sub_menu, {
                ...
                default: withCtx(() => [
                  (openBlock(true), createElementBlock(Fragment, null, renderList(item[__props.children], (it, i2) => {
                    return openBlock(), createBlock(_component_el_menu_item, {
                      key: i2,
                      index: it[__props.index]
                    }, {
                      default: withCtx(() => [
                        it[__props.icon] ? (openBlock(), createBlock(resolveDynamicComponent(`el-icon-${unref(toLine)(it[__props.icon])}`), { key: 0 })) : createCommentVNode("", true),
                        createElementVNode("span", null, toDisplayString(it[__props.name]), 1)
                      ]),
                      _: 2
                    }, 1032, ["index"]);
                  }), 128))
...
var menu$1 = /* @__PURE__ */ _export_sfc$1(_sfc_main$4q, [["__scopeId", "data-v-aa57324a"]]);
...
var infiniteMenu = defineComponent({
  ...
  setup(props, ctx) {
    ...
    return () => {
      let _slot;
      return createVNode(resolveComponent("el-menu"), mergeProps(attrs, {
        "router": props.router,
