import { defineComponent, computed, ref, onMounted, watch, resolveComponent, resolveDirective, withDirectives, openBlock, createBlock, mergeProps, withCtx, createElementBlock, Fragment, renderList, unref, renderSlot, toDisplayString, createCommentVNode } from "vue";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: emits }) {
    ...
    const tableData = ref(cloneDeep_1(props.data));
    let editIndex = ref(props.editRowIndex);
    onMounted(() => {
    ...
    return (_ctx, _cache) => {
      ...
      return withDirectives((openBlock(), createBlock(_component_el_table, mergeProps(_ctx.$attrs, {
              ...
              default: withCtx((scope) => [
                scope.row.rowEdit ? (openBlock(), createBlock(_component_el_input, {
                  ...
                  item.slot ? renderSlot(_ctx.$slots, item.slot, {
                    key: 0,
                    scope
                  }) : (openBlock(), createElementBlock("span", _hoisted_1, toDisplayString(scope.row[item.prop]), 1))
                ], 64))
              ]),
              _: 2
            }, 1032, ["width", "label", "prop", "align"]);
          }), 128)),
          unref(actionOptions) ? (openBlock(), createBlock(_component_el_table_column, {
            key: 0,
            width: unref(actionOptions).width,
            label: unref(actionOptions).label,
            prop: unref(actionOptions).prop,
            align: unref(actionOptions).align
          }, {
            default: withCtx((scope) => [
              scope.row.rowEdit ? renderSlot(_ctx.$slots, "rowEdit", {
                key: 0,
                scope
            ...
            _: 3
          }, 8, ["width", "label", "prop", "align"])) : createCommentVNode("", true)
        ]),
        _: 3
      }, 16, ["data"])), [
